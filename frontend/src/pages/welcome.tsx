...
// @ts-ignore - Footer component not yet converted to TypeScript
import Footer from '../components/Footer';
// @ts-ignore - Navbar component already converted but may have implicit any imports
import NavBar from '../components/Navbar';

type ActiveTab = 'student' | 'tutor';
